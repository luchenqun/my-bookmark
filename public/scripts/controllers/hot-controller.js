app.controller('hotCtr', [
  ...
  'pubSubService',
  'dataService',
  function ($scope, $state, $sce, $filter, $window, $timeout, $document, pubSubService, dataService) {
    ...
    $scope.toastrId = 0;
    $scope.random = 0;
    $scope.channels = JSON.parse(
      `[{"id":0,"name":"收趣"},{"id":-1,"name":"随机一批"},{"id":1,"name":"热门"},{"id":2,"name":"搞笑"},{"id":3,"name":"养生堂"},{"id":4,"name":"私房话"},{"id":5,"name":"八卦精"},{"id":6,"name":"科技咖"},{"id":7,"name":"财经迷"},{"id":8,"name":"汽车控"},{"id":9,"name":"生活家"},{"id":10,"name":"时尚圈"},{"id":11,"name":"育儿"},{"id":12,"name":"旅游"},{"id":13,"name":"职场"},{"id":14,"name":"美食"},{"id":15,"name":"历史"},{"id":16,"name":"教育"},{"id":17,"name":"星座"},{"id":18,"name":"体育"},{"id":19,"name":"军事"},{"id":20,"name":"游戏"},{"id":21,"name":"萌宠"}]`
    );
      ...
      $timeout(function () {
        ...
        if (body.status == 0) {
          ...
          weixinArticles.forEach((articl, index) => {
            ...
            bookmark.content = articl.content
              .replace(/https:\/\/mmbiz.qpic.cn/gi, 'https://favicon.lucq.fun/qpic?url=https://mmbiz.qpic.cn')
              .replace(/http:\/\/mmbiz.qpic.cn/gi, 'https://favicon.lucq.fun/qpic?url=https://mmbiz.qpic.cn');
