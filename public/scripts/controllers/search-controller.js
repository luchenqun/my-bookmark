app.controller('searchCtr', [
  ...
  'pubSubService',
  'dataService',
  function ($scope, $state, $stateParams, $filter, $window, $timeout, $document, ngDialog, pubSubService, dataService) {
    ...
    $scope.updateCreateDate = async function () {
      ...
      if ($scope.dateCreateBegin && $scope.dateCreateEnd) {
        ...
        $('.js-create-date .text')
          .text($scope.dateCreateBegin + ' 至 ' + $scope.dateCreateEnd)
          .removeClass('default');
      }
    };
    ...
    $scope.updateClickDate = async function () {
      ...
      if ($scope.dateClickBegin && $scope.dateClickEnd) {
        ...
        $('.js-click-date .text')
          .text($scope.dateClickBegin + ' 至 ' + $scope.dateClickEnd)
          .removeClass('default');
      }
    };
