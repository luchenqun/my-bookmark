          ...
          function (d, f, g) {
            ...
            (f.$$inheritedValues && e(t, m(f.$$inheritedValues, p)),
              ...
              f.$$values
                ...
                : (f.$$inheritedValues && (r.$$inheritedValues = m(f.$$inheritedValues, p)),
                  f.then(h, i)));
      ...
      function h(e, f) {
        ...
        return (
          ...
          h &&
            (j =
              U.type(h) ||
              d(U.type('string'), { pattern: new RegExp(h, b.caseInsensitive ? 'i' : c) })),
    ...
    function v(a, e) {
      ...
      function t(a, b) {
        return N(a) && !L(b)
          ? C[a]
          : M(b) && N(a)
            ? (C[a] && !C.$delegates[a] && (C.$delegates[a] = C[a]), (C[a] = b), this)
            : this;
      }
      function u(a, b) {
            ...
            return (
              Q(a.views, function (d, e) {
                ...
                ((g.$template = [
                  function () {
                    return (
                      f.load(e, { view: d, locals: i.globals, params: n, notify: j.notify }) || ''
                    );
                  }
                ]),
                  c.push(
          ...
          (y.transitionTo = function (b, c, f) {
            ...
            if (f.reload) {
              if (N(f.reload) || O(f.reload)) {
                ...
                if (f.reload && !I)
                  throw new Error(
                    "No such reload state '" + (N(f.reload) ? f.reload : f.reload.name) + "'"
                  );
            ...
            if (
              ...
              r && (c['#'] = r),
              f.notify &&
                a.$broadcast('$stateChangeStart', b.self, c, j.self, l, f).defaultPrevented)
            )
              return (
