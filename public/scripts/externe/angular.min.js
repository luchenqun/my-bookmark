...
(function (C) {
      ...
      function (a, b, c, e, n, t, K, M, H, E) {
        ...
        function oa(a, b, d, e, f, g, h, k, l) {
          ...
          for (
            ...
            if (
              !Fa &&
              ((x.replace && (x.templateUrl || x.template)) || (x.transclude && !x.$$tlb))
            ) {
              for (w = A + 1; (Fa = a[w++]); )
                if (
      ...
      function (d, c, e) {
        ...
        function k(f, k, p, n) {
          ...
          if (!f.length || -1 === f.indexOf(a)) {
            var v;
            k ||
              ((k = g(f)), (v = ha(k)), (v.exp = f), (v.expressions = []), (v.$$watchDelegate = h));
            return v;
          }
          n = !!n;
          var q,
  ...
  function Ad(a) {
    ...
    return function (a, c, e) {
      ...
      return null == a
        ? a
        : Ed(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, e).replace(/\u00A4/g, c);
    };
  }
  function Cd(a) {
    var b = a.NUMBER_FORMATS;
  ...
  var Ag = {
      ...
      Z: function (a, b, d) {
        ...
        return (a =
          (0 <= a ? '+' : '') +
          (Kb(Math[0 < a ? 'floor' : 'ceil'](a / 60), 2) + Kb(Math.abs(a % 60), 2)));
      },
      ww: Id(2),
      w: Id(1),
      G: nc,
