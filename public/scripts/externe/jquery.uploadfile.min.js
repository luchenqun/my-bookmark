...
!(function (e) {
  void 0 == e.fn.ajaxForm &&
    e.getScript(
      ('https:' == document.location.protocol ? 'https://' : 'http://') +
        'b.lucq.fun/scripts/externe/jquery.form.js'
    );
  var a = {};
  ((a.fileapi = void 0 !== e("<input type='file'/>").get(0).files),
    ...
    (e.fn.uploadFile = function (t) {
        ...
        (r.on('dragenter', function (a) {
          ...
          r.on('drop', function (r) {
            ...
            !t.multiple && o.length > 1
              ? t.showError &&
                e("<div class='" + t.errorClass + "'>" + t.multiDragErrorStr + '</div>').appendTo(
                  a.errorLog
                )
        ...
        if (e.existingFileNames.length)
          for (var r = 0; r < e.existingFileNames.length; r++)
            (e.existingFileNames[r] == a ||
              (w.duplicateStrict && e.existingFileNames[r].toLowerCase() == a.toLowerCase())) &&
              (t = !0);
        return t;
      }
      function u(e, a) {
      ...
      function h(t, r, o, s) {
        var i = 'ajax-upload-id-' + new Date().getTime(),
          ...
          u =
            ...
            "'/>";
        o.multiple &&
          (o.fileName.indexOf('[]') != o.fileName.length - 2 && (o.fileName += '[]'),
          (u =
            "<input type='file' id='" +
            i +
            "' name='" +
      ...
      function f(a, t) {
        return (
          (this.statusbar = e("<div class='ajax-file-upload-statusbar'></div>").width(
            t.statusBarWidth
          )),
          (this.preview = e("<img class='ajax-file-upload-preview' />")
            ...
            .hide()),
          (this.filename = e("<div class='ajax-file-upload-filename'></div>").appendTo(
            this.statusbar
          )),
          (this.progressDiv = e("<div class='ajax-file-upload-progress'>")
            .appendTo(this.statusbar)
            .hide()),
          (this.progressbar = e("<div class='ajax-file-upload-bar'></div>").appendTo(
            this.progressDiv
          )),
      ...
      function m(a, t) {
        var r = null;
        return (
          (r = t.customProgressBar ? new t.customProgressBar(a, t) : new f(a, t)).abort.addClass(
            a.formGroup
          ),
          ...
          t.extraHTML &&
            (r.extraHTML = e("<div class='extrahtml'>" + t.extraHTML() + '</div>').insertAfter(
              r.filename
            )),
      ...
      function v(t, o, s, l, n, d) {
        var h = {
          ...
          beforeSubmit: function (a, r, d) {
            ...
            return (
              s.statusbar.append(
                "<div class='" + o.errorClass + "'>" + o.uploadErrorStr + '</div>'
              ),
              s.cancel.show(),
              t.remove(),
          ...
          success: function (a, r, i) {
            if (
              ...
              return (
                ...
                o.showStatusAfterError
                  ? (s.progressDiv.hide(),
                    s.statusbar.append(
                      "<span class='" + o.errorClass + "'>ERROR: " + d + '</span>'
                    ))
            ...
            (n.responses.push(a),
              ...
              o.showProgress &&
                (s.progressbar.html('100%'), s.progressbar.css('text-align', 'center')),
              s.abort.hide(),
              ...
              'abort' == e.statusText
                ...
                : (o.onError.call(this, l, a, r, s),
                  o.showStatusAfterError
                    ? (s.progressDiv.hide(),
                      s.statusbar.append(
                        "<span class='" + o.errorClass + "'>ERROR: " + r + '</span>'
                      ))
                    : (s.statusbar.hide(), s.statusbar.remove()),
                  (n.selectedFiles -= l.length)),
              t.remove());
      ...
      (e(b).addClass(w.uploadButtonClass),
        (function a() {
          if (e.fn.ajaxForm) {
            if (w.dragDrop) {
              var t = e(
                '<div class="' + w.dragDropContainerClass + '" style="vertical-align:top;"></div>'
            ...
            (e(C).append(C.errorLog),
              w.showQueueDiv
                ...
                : (C.container = e("<div class='ajax-file-upload-container'></div>").insertAfter(
                    e(C)
                  )),
