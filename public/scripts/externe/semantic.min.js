            ...
            (P = {
              ...
              clear: function () {
                m.each(function () {
                  var t = e(this),
                    ...
                    s = n.is(x.uiDropdown);
                  (i.hasClass(C.error) &&
                    (P.verbose('Resetting error on field', i), i.removeClass(C.error), o.remove()),
                    s
              ...
              is: {
                ...
                empty: function (e) {
                  return (
                    !e ||
                    0 === e.length ||
                    (e.is('input[type="checkbox"]') ? !e.is(':checked') : P.is.blank(e))
                  );
                },
                blank: function (t) {
                  return '' === e.trim(t.val());
                    ...
                    v.inline &&
                      ...
                      r
                        ...
                        : v.transition && e.fn.transition !== i && E.transition('is supported')
                          ...
                          : (P.verbose('Displaying error with fallback javascript animation'),
                            a.fadeIn(v.duration))));
                },
                errors: function (e) {
                ...
                rule: function (t, n) {
                  ...
                  b[t] != i &&
                    ...
                    e.each(b[t].rules, function (e, n) {
                      -1 !== o.indexOf(n.type) &&
                        (P.debug('Removed rule', n.type), b[t].rules.splice(e, 1));
                    });
                },
                field: function (t) {
              ...
              validate: {
                ...
                field: function (t, n, o) {
                  ...
                  return (
                    t.identifier ||
                      (P.debug('Using field name as identifier', a), (t.identifier = a)),
                    r.prop('disabled')
      ...
      (e.fn.form.settings = {
        ...
        rules: {
          ...
          regExp: function (t, n) {
            ...
            return (
              o && ((n = o.length >= 2 ? o[1] : n), (i = o.length >= 3 ? o[2] : '')),
              ...
              create: {
                label: function () {
                  S.prevAll(v.label).length > 0
                    ? (S.prev(v.label).detach().insertAfter(S), m.debug('Moving existing label', w))
                    : m.has.label() ||
                      ((w = e('<label>').insertAfter(S)), m.debug('Creating label', w));
                }
              },
              has: {
                label: function () {
          ...
          a.each(function () {
            ...
            ((m = {
              ...
              create: function () {
                ...
                return (
                  g.dimmerName &&
                    (m.debug('Creating named dimmer', g.dimmerName), t.addClass(g.dimmerName)),
                  t.appendTo(f),
                  t
                );
              },
                ...
                show: function (t) {
                  ((t = e.isFunction(t) ? t : function () {}),
                    g.useCSS && e.fn.transition !== i && d.transition('is supported')
                      ? (g.useFlex
                          ? (m.debug('Using flex dimmer'), m.remove.legacy())
                          : (m.debug('Using legacy non-flex dimmer'), m.set.legacy()),
            ...
            ((S = {
                  ...
                  (S.debug('Dropdown initialized on a select', t),
                    ...
                    U.parent(D.dropdown).length > 0
                      ...
                      : (S.debug('Creating entire dropdown from select'),
                        ...
                        U.prop('disabled') &&
                          (S.debug('Disabling dropdown'), M.addClass(T.disabled)),
                ...
                touchEvents: function () {
                  (S.debug('Touch device detected binding additional touch events'),
                    S.is.searchSelection() ||
                      (S.is.single() && M.on('touchstart' + z, S.event.test.toggle)),
                ...
                var i = {
                  ...
                  onSuccess: function (t) {
                    ...
                    (e.isArray(i) && i.length > 0
                      ? (S.remove.message(), S.setup.menu({ values: t[R.remoteValues] }))
                      : S.add.message(A.noResults),
                      n());
                  }
                };
                ...
                search: {
                  ...
                  blur: function (e) {
                    ((v = n.activeElement === this),
                      S.is.searchSelection() &&
                        !b &&
                        (Y || v || (k.forceSelection && S.forceSelection(), S.hide())),
                      (b = !1));
                  }
                },
                icon: {
                ...
                label: {
                  click: function (t) {
                    var n = e(this),
                      ...
                      s =
                        a.length > 0 ? n.nextUntil(a).add(o).add(n) : n.prevUntil(r).add(o).add(n);
                    (t.shiftKey
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (
                          ((n =
                            d && c
                              ? a.prevAll(D.item + ':not(' + D.unselectable + ')').eq(0)
                              : X.eq(0)),
                          r.index(n) < 0)
                        )
                          return (
                            S.verbose('Up key pressed but reached top of current menu'),
                      ...
                      if (t == P.downArrow) {
                        if (
                          ...
                          (n =
                            d && c
                              ? (n = a.nextAll(D.item + ':not(' + D.unselectable + ')').eq(0))
                              : X.eq(0)).length
                        )
                          return (
                            S.verbose('Down key pressed but reached bottom of current menu'),
                            void e.preventDefault()
                          );
                  ...
                  return (
                    ...
                    o &&
                      X.each(function () {
                        ...
                        if (null !== l && l !== i)
                          if (a)
                            (-1 === e.inArray(String(l), t) && -1 === e.inArray(s, t)) ||
                              (r = r ? r.add(o) : o);
                          else if (n) {
                            if (
                              (S.verbose('Ambiguous dropdown value using strict type check', o, t),
                              l === t || s === t)
                            )
                              return ((r = o), !0);
              ...
              set: {
                filtered: function () {
                  ...
                  (e &&
                    o &&
                    (S.verbose('Adjusting input width', a, k.glyphWidth), N.css('width', a)),
                    o || (n && r)
                      ? (S.verbose('Hiding placeholder text'), V.addClass(T.filtered))
                      : (!e || (n && !r)) &&
                        (S.verbose('Showing placeholder text'), V.removeClass(T.filtered)));
                },
                empty: function () {
                  M.addClass(T.empty);
                },
                ...
                value: function (e, t, n) {
                  ...
                  if (a) {
                    if (
                      !k.allowReselection &&
                      s == r &&
                      (S.verbose('Skipping value update already same value', e, r),
                      !S.is.initialLoad())
                    )
                      return;
                    (S.is.single() &&
                    ...
                    (S.verbose('Storing value in metadata', o, U), o !== r && M.data(E.value, s));
                  (S.is.single() && k.clearable && (o ? S.set.clearable() : S.remove.clearable()),
                    !1 === k.fireOnInit && S.is.initialLoad()
                          ...
                          ? (k.apiSettings && k.saveRemoteData && S.save.remoteData(o, a),
                            k.useLabels
                              ...
                              : (S.add.value(a, o, t),
                                ...
                                S.set.activeItem(t)))
                          : r ||
                            (S.debug('Selected active value, removing label'), S.remove.selected(a))
                        : (k.apiSettings && k.saveRemoteData && S.save.remoteData(o, a),
                          S.set.text(o),
                          S.set.value(a, o, t),
                    ...
                    ('' === e || o
                      ...
                      : (a
                          ? (n
                            ...
                            k.hideAdditions ||
                              ((t = k.templates.addition(S.add.variables(A.addResult, e))),
                              n.html(t)),
                  ...
                  S.has.value(t)
                    ...
                    : '' !== t
                      ? (e.isArray(a)
                        ...
                        S.has.selectInput()
                          ? S.can.extendSelect() &&
                            (S.debug('Adding value to select', t, o, U), S.add.optionValue(t))
              ...
              remove: {
                ...
                optionValue: function (e) {
                  ...
                  n.length > 0 &&
                    ...
                    (C &&
                      (C.disconnect(), S.verbose('Temporarily disconnecting mutation observer')),
                    n.remove(),
                  ...
                  ((t = t || M.find(D.label)),
                    ...
                    t.each(function () {
                      ...
                      !1 !== k.onLabelRemove.call(t, n)
                        ? (S.remove.message(),
                          a ? (S.remove.value(o), S.remove.label(o)) : S.remove.selected(o))
              ...
              has: {
                ...
                minCharacters: function (e) {
                  return (
                    !k.minCharacters ||
                    (e = e !== i ? String(e) : String(S.get.query())).length >= k.minCharacters
                  );
                },
              ...
              is: {
                ...
                alreadySetup: function () {
                  return (
                    M.is('select') && M.parent(D.dropdown).data(I) !== i && 0 === M.prev().length
                  );
                },
          ...
          r.each(function () {
            ...
            ((k = {
              ...
              hideOthers: function (t) {
                ...
                ((t = e.isFunction(t) ? t : function () {}),
                  n.length > 0 &&
                    (k.debug('Hiding other modals', v), n.modal('hide modal', t, !0)));
              },
              others: {
                active: function () {
              ...
              remove: {
                ...
                bodyStyle: function () {
                  '' === c.attr('style') &&
                    (k.verbose('Removing style attribute'), c.removeAttr('style'));
                },
              ...
              set: {
                ...
                dimmerStyles: function () {
                  (T.inverted ? x.addClass(R.inverted) : x.removeClass(R.inverted),
                    T.blurring ? y.addClass(R.blurring) : y.removeClass(R.blurring));
                },
                modalOffset: function () {
                  var e = k.cache.width,
                    t = k.cache.height;
                  (D.css({ marginTop: T.centered && k.can.fit() ? -t / 2 : 0, marginLeft: -e / 2 }),
        ...
        return (
          r.each(function () {
            ...
            ((x = {
              ...
              observeChanges: function () {
                'MutationObserver' in t &&
                  ((v = new MutationObserver(x.event.documentChanged)).observe(n, {
                    childList: !0,
                    subtree: !0
                  }),
                  ...
                  C.popup
                    ? (r.addClass(S.loading),
                      ...
                      C.movePopup &&
                        ...
                        (x.debug('Moving popup to the same offset parent as target'),
                        r.detach().appendTo(h)))
                    : (h = C.inline
              ...
              show: function (e) {
                if (
                  ...
                  (C.preserve || C.popup || x.refresh(),
                    r &&
                      x.set.position() &&
                      (x.save.conditions(), C.exclusive && x.hideAll(), x.animate.show(e)));
                }
              },
              hide: function (e) {
              ...
              removePopup: function () {
                x.has.popup() &&
                  !C.popup &&
                  (x.debug('Removing popup', r), r.remove(), (r = i), C.onRemove.call(r, M));
              },
              save: {
                conditions: function () {
              ...
              bind: {
                ...
                popup: function () {
                  (x.verbose('Allowing hover events on popup to prevent closing'),
                    r &&
                      x.has.popup() &&
                      r.on('mouseenter' + R, x.event.start).on('mouseleave' + R, x.event.end));
                },
                close: function () {
              ...
              is: {
                ...
                offstage: function (t, n) {
                  ...
                  return (
                    e.each(t, function (e, t) {
                      t < -C.jitter &&
                        (x.debug('Position exceeds allowable distance from edge', e, t, n),
                        i.push(e));
                    }),
                    i.length > 0
                  );
          ...
          ((a = {
            ...
            read: {
              metadata: function () {
                ...
                (e.percent &&
                  (a.debug('Current percent value set from metadata', e.percent),
                  a.set.percent(e.percent)),
                  e.total &&
                    (a.debug('Total value set from metadata', e.total), a.set.total(e.total)),
                  e.value &&
              ...
              settings: function () {
                (!1 !== f.total &&
                  (a.debug('Current total set in settings', f.total), a.set.total(f.total)),
                  !1 !== f.value &&
            ...
            get: {
              ...
              normalizedValue: function (e) {
                ...
                if (a.has.total()) {
                  if (e > a.total)
                    return (a.debug('Value cannot increment above total', a.total), a.total);
                } else if (e > 100)
                  return (a.debug('Value cannot increment above 100 percent'), 100);
                return e;
              },
            ...
            set: {
              ...
              labelInterval: function () {
                (clearInterval(a.interval),
                  ...
                  (a.interval = setInterval(function () {
                    (e.contains(n.documentElement, k) || (clearInterval(a.interval), (A = !1)),
                      a.set.labels());
                  }, f.framerate)));
              },
              labels: function () {
              ...
              label: function (e) {
                (e = e || '') &&
                  ((e = a.get.text(e)), a.verbose('Setting label to text', e), S.text(e));
              },
              state: function (e) {
              ...
              progress: function (e) {
                a.has.progressPoll()
                  ? (a.debug('Updated within interval, setting next update to use new value', e),
                    a.set.nextValue(e))
              ...
              event: {
                ...
                click: function () {
                  var t = e(this),
                    n = f.get.rating(),
                    i = S.index(t) + 1;
                  ('auto' == m.clearable ? 1 === S.length : m.clearable) && n == i
                    ? f.clearRating()
                    : f.set.rating(i);
                }
              },
            ...
            ((m = {
                    ...
                    m.resultsClicked
                      ? (m.debug('Determining if user action caused search to close'),
                        k.one('click.close' + w, y.results, function (e) {
                          m.is.inMessage(e) || O
                            ? T.focus()
                            : ((O = !1), m.is.animating() || m.is.hidden() || t());
                        }))
                ...
                result: {
                  ...
                  click: function (n) {
                    ...
                    if (e.isFunction(g.onSelect) && !1 === g.onSelect.call(E, u, c))
                      return (
                        m.debug('Custom onSelect callback cancelled default select action'),
                        void (O = !0)
                      );
                    (m.hideResults(),
                      l && m.set.value(l),
              ...
              is: {
                ...
                inMessage: function (t) {
                  if (t.target) {
                    var i = e(t.target);
                    return (
                      e.contains(n.documentElement, t.target) && i.closest(y.message).length > 0
                    );
                  }
                },
                empty: function () {
              ...
              search: {
                local: function (e) {
                  ...
                  (m.set.loading(),
                    ...
                    g.maxResults > 0 &&
                      (m.debug('Using specified max results', n), (n = n.slice(0, g.maxResults))),
                ...
                cache: function (e) {
                  ...
                  e
                    ? e &&
                      t &&
                      t[e] &&
                      (m.debug('Removing value from cache', e), delete t[e], k.data(h.cache, t))
              ...
              inject: {
                result: function (e, t, n) {
                  ...
                  var o =
                    n !== i
                      ? R.children().eq(n).children(y.results).first().children(y.result).eq(t)
            ...
            ((w = {
              ...
              event: {
                clickaway: function (e) {
                  ...
                  (t && (w.verbose('User clicked on dimmed page'), w.hide()),
                    n &&
                      (w.verbose('User clicked on dimmable context (scaled out page)'), w.hide()));
                },
                touch: function (e) {},
              ...
              bind: {
                clickaway: function () {
                  (w.verbose('Adding clickaway events to context', D),
                    S.closable &&
                      D.on('click' + b, w.event.clickaway).on('touchend' + b, w.event.clickaway));
                },
                scrollLock: function () {
                  (S.scrollLock &&
                    (w.debug('Disabling page scroll'), s.on('DOMMouseScroll' + b, w.event.scroll)),
              ...
              pushPage: function (t) {
                ...
                ((t = e.isFunction(t) ? t : function () {}),
                  ...
                  (o = function (e) {
                    e.target == r[0] &&
                      (r.off(C + b, o), w.remove.animating(), w.bind.scrollLock(), t.call(z));
                  }),
                  r.off(C + b),
                  r.on(C + b, o),
                  v(n),
              ...
              is: {
                ...
                rtl: function () {
                  return (
                    w.cache.rtl === i && (w.cache.rtl = 'rtl' == O.css('direction')),
                    w.cache.rtl
                  );
                }
              },
              ...
              get: {
                ...
                displayType: function (e) {
                  return (
                    ...
                    m.displayType
                      ? m.displayType
                      : (e && w.data(v.displayType) === i && C.can.transition(!0),
            ...
            ((h = {
              ...
              is: {
                ...
                validResponse: function (t) {
                  return h.is.expectingJSON() && e.isFunction(v.successTest)
                    ...
                    : (h.verbose('Response is not JSON, skipping validation', v.successTest, t),
                      !0);
                }
              },
              was: {
                ...
                complete: function () {
                  return (
                    h.request &&
                    ('resolved' == h.request.state() || 'rejected' == h.request.state())
                  );
                }
              },
              add: {
                ...
                formData: function (t) {
                  ...
                  return (
                    ...
                    e.isPlainObject(t)
                      ? n
                        ? (h.debug('Extending existing data with form data', t, o),
                          (t = e.extend(!0, {}, t, o)))
              ...
              event: {
                ...
                xhr: {
                  ...
                  fail: function (e, t, n) {
                    ...
                    ((a = a > 0 ? a : 0) > 0 &&
                      h.debug('Response completed early delaying state change by', a),
                      setTimeout(function () {
              ...
              get: {
                responseFromXHR: function (t) {
                  return (
                    !!e.isPlainObject(t) &&
                    (h.is.expectingJSON() ? h.decode.json(t.responseText) : t.responseText)
                  );
                },
                ...
                defaultData: function () {
                  ...
                  return (
                    e.isWindow(P) ||
                      (h.is.input() ? (t.value = T.val()) : h.is.form() || (t.text = T.text())),
                    t
                  );
                },
                event: function () {
          ...
          r.each(function () {
            ...
            ((v = {
              ...
              passingReverse: function (e) {
                ...
                if (
                  (e &&
                    (v.debug('Adding callback for passing reverse', e), (b.onPassingReverse = e)),
                  t.passing
